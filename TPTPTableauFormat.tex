...
The root node is the top \smalltt{\$true} box.
...
In {\tt reduction} and {\tt lemma\_extension} steps the relevant ancestor/lemma lights up when 
the cursor is hovered over the reduced/extension node.
...
Future work includes completing the extension of GDV, and adding highlighting features to ITV as
explained in Section~\ref{SystemsTools}.
In the larger picture, the format can be extended to record non-clausal tableaux~\cite{Ott17,Ott18}.

%--------------------------------------------------------------------------------------------------
\paragraph{\bf Acknowledgments}
\begin{packed_itemize}
\item For the purpose of open access, the author has applied a Creative Commons Attribution 
