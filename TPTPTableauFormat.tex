...
In the current version of ITV the user has to examine the tableau to find the ancestor node
used in a {\tt reduction} step, and the lemma used in a {\tt lemma\_extension} step, but soon
the relevant ancestor/lemma will light up when the cursor is hovered over the 
reduced/extension node.
...
\end{enumerate}
The new format has been adopted in the \cpp\ ATP system, and 
the existing GDV and IDV tools for verifying and viewing derivations have been adapted to 
verifying and viewing tableau proofs.
