...
\cpp\ is an ATP for first-order logic with equality, using the connection calculus 
to construct proofs.
It is implemented in C++ and freely available under the GNU General Public License 
(GPL) Version 3.\footnote{%
...
program. 
From version 0.7.0 \cpp\ can also produce closed tableau in the format described here.
...
\item ITV was implemented at the University of Miami by Daniel Li and Esteban Morales, building
      in the IDV code of Jack McKeown.
\end{packed_itemize}
