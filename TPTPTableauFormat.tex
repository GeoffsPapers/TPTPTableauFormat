...
Structural verification deals with non-logical aspects of a proof, checking whether the the 
...
The IDV Interactive Derivation Viewer~\cite{TPS07} provides a graphical rendering of a proof DAG. 
It has features that allow the user to examine the proof structure in various way, including 
...
The extension of GDV to verify tableau proofs requires extending the structural verification phase,
