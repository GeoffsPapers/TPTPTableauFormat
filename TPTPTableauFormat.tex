...
The TPTP format uses five inference rules:

\paragraph{{\tt extension}:} The standard tableau extension rule.
For example, {\smalltt{t2}} extends from the first literal {\smalltt{q(b)}} of {\smalltt{t1}} to 
the 1st literal {\smalltt{{\mytilde}q(b)}} of {\smalltt{c2}}.
...
For example, {\smalltt{t3}} closes the branch of the contradiction between {\smalltt{q(b)}} and
{\smalltt{{\mytilde}q(b)}} in the extension {\smalltt{t2}}.
...
For example, {\smalltt{t8}} closes the branch of the contradiction between the 2nd literal
{\smalltt{{\mytilde}q(b)}} of {\smalltt{t6}} and the 1st literal {\smalltt{q(b)}} of 
{\smalltt{t1}}.
...
For example, {\smalltt{l1}} is the lemma {\smalltt{p(c)}} created when the branch rooted at
{\smalltt{t2:2}} is closed.
...
For example, {\smalltt{t11}} is the result of using the lemma {\smalltt{l1}} to close the branch
down to {\smalltt{9:2}}.
