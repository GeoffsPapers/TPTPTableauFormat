...
Points of note:
all the leaf formulae except {\tt a4} and {\tt a5} are copies of formulae in the problem;
{\tt a4} and {\tt a5} are easily derived from the corresponding problem formulae;
...
The path to this point is recorded as \smalltt{[0:0]}, indicating that the node above is the 
root node.
...
The path to this point is recorded as \smalltt{[t1:1,0:0]}. 
...
The path to this point is recorded as \smalltt{[t2:1,t1:1,0:0]}.
...
to \smalltt{t8}.
The path to this point is recorded as \smalltt{[t6:2,t4:2,t2:2,t1:1,0:0]}.
...
The path to this point is recorded as \smalltt{[t2:2,t1:1,0:0]}.
...
The path to this point is recorded as \smalltt{[t11:1,t9:2,t2:3,t1:1,0:0]}.
...
\item All paths start at the root \smalltt{0:0} node.
...
\begin{enumerate}
\item Easy reconstruction of the tableau - this is can be done directly from the \smalltt{path}s.
\item Sufficient information for structural verification of the closed tableau - this is provided
      by the \smalltt{path}s, the \smalltt{below} record in lemmas, and the explicit closing of
      each path with {\tt connection} steps and after {\tt reduction} steps.
