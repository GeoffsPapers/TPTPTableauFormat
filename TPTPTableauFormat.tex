...
The path to this point is recorded as {\smalltt{path([t1:1,0:0])}}. 
...
The path to this point is recorded as {\smalltt{path([t2:1,t1:1,0:0])}}.
...
to {\smalltt{t8}}.
The path to this point is recorded as {\smalltt{path([t6:2,t4:2,t2:2,t1:1,0:0])}}.
...
The path to this point is recorded as {\smalltt{path([t2:2,t1:1,0:0])}}.
...
The path to this point is recorded as {\smalltt{path([t11:1,t9:2,t2:3,t1:1,0:0])}}.
...
The IDV derivation viewer has been adapted to display a tableau proof, as the Interactive
Tableau Viewer (ITV) tool.
