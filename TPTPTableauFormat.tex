...
In the current version of ITV the users has to examine the tableau to find the ancester node
used in a {\tt reduction} step, and the lemma used in a {\tt lemma\_extension} step, but soon
the relevant ancestor/lemm will be highlighted when the cursor is hovered over the 
