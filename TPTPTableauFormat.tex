...
One early proposal for a TPTP style format for writing WHAT never gained traction~\cite{OS10}.
...
(In the long-term the format might be extended to record non-connection~\cite{WHAT} and non-clausal 
tableaux~\cite{Ott17,Ott18}.)
...
of requirements~2 and~3 due to the omission of some necessary details. WHAT
As claimed in~\cite{OH23}, that early proposal might have also failed to have the features~4 and~5.
Another existing TPTP style format is the leanTPTP format FOR WHAT output by the leanCoP ATP 
system~\cite{OB03}.
The leanTPTP format definitely meets requirement~4, but omits the information required for 
requirements~1,~2, and~3.
A more recent proposal a TPTP style format for clausal connection tableaux left some important 
information WHAT implicit.~\cite{OH23} 
That information is explicit in the format for clausal connection tableaux proposed here.
The TPTP format for writing clausal connection tableaux meets all the requirements.
