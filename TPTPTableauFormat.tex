...
A degenerate for of {\tt reduction}.

\paragraph{{\tt reduction}:} The standard tableau reduction rule.

\paragraph{{\tt lemma}:} The creation of a unit lemma.
Available below the lowest node in the tableau that was used in a reduction that contributed
to closing a branch.

\paragraph{{\tt lemma\_extension}:} Use of a lemma to close a branch.
Very similar to an extension.
